...
tmp/gaskit/sponsor-faucet-request.json`. That command sends the public sponsor
...
tmp/gaskit/sponsor-funding-report.json` before retrying. The funding
...
redacted/aggregate shape for `GASKIT_SPONSOR_FUNDING_REPORT`; it does not
