...
The A2A public-readiness proof separates local A2A loopback evidence from
public hosting, production keys, streaming, push notifications, and external
...
| A2A public readiness | `npm run proof:a2a-public-readiness` classifies local A2A proof, local loopback streaming, public hosting inputs, production JWKS/auth decisions, unsupported push capability, and external conformance blockers without contacting public endpoints. | [A2A Public Readiness](agentic-gaskit/a2a-public-readiness.md) |
...
- public Agent Card hosting, production Agent Card key management, live A2A
  task/message server operation, public streaming, push notifications, external
