...
Documented public IOTA testnet evidence already in the repo: latest digest `Fc32GFCU95wUGs5iGjewJuMxxXwtRrjzLh3LUGrf85uf` plus earlier 2026-06-14 digests `FLdnYRUACAKQn8CwugEv1u6gYTh9jBr8rGMk2JZ2adsd` and `6Fz2r2ARRo6fiQMUL4FkWuwU16ekEmKHvHbhLpF5DU6n` in `docs/testnet-attempts.md` and `docs/agentic-gaskit/testnet-digest-proof.md`.
