...
- A2A public-readiness wiring for local proof, local authenticated extended
  ...
  loopback streaming, local push notification configuration, local injected
  push delivery, local opt-in push HTTP transport, callback URL admission
  ...
  injected-transport worker, public hosting inputs, redacted structured public
