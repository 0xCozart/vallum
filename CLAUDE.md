# AgentRail Project Rules

This fork is the AgentRail implementation path created from the original IOTA
...
- `docs/agentrail/migration-plan.md` - repo migration, branding, package,
...
- `docs/agentrail/account-wallet-safety.md` - wallet/signer-reference
  safety model.
- `docs/agentrail/execution-slices.md` - implementation queue.
- `docs/agentrail/verification-hardening.md` - verification and risk
  gates.
...
- Keep existing AgentRail checks passing unless the slice intentionally changes
  their contract.
...
reviewed AgentRail profile with no external tracker, focused-search code
