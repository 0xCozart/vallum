  ...
  try {
    const report = await checkPackagePublicationReadiness({
      ...
      scripts: {
        ...
        "smoke:package-paid-mcp-consumer": "tsx scripts/smoke-package-paid-mcp-consumer.ts",
        "smoke:npm-registry-paid-mcp-consumer": "tsx scripts/smoke-npm-registry-paid-mcp-consumer.ts",
