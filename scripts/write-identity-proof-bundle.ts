...
export interface IdentityProofBundle {
  ...
  readonly kind: "agentic-gaskit.identity-proof-bundle";
...
export async function writeIdentityProofBundle(
  ...
  const bundle: IdentityProofBundle = {
    schemaVersion: 1,
    kind: "agentic-gaskit.identity-proof-bundle",
...
function buildSteps(input: {
  ...
  return [
    ...
    },
    {
      ...
      command: "npm run smoke:iota-names-live -- --report tmp/gaskit/iota-names-live-report.json",
    ...
    },
    {
      ...
      command: "npm run smoke:iota-identity-live -- --report tmp/gaskit/iota-identity-live-report.json",
      contactsLiveService: true,
      requiresOperatorApproval: true,
    ...
    },
    {
      ...
      command: "npm run proof:live-status -- --out tmp/gaskit/live-proof-status.json",
      contactsLiveService: false,
      requiresOperatorApproval: false,
