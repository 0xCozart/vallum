...
function productionBlockers(): readonly ProductEvidenceCheck[] {
  return [
    ...
    },
    {
      ...
      message: "A2A discovery, task routes, authenticated extended Agent Card access, SSE streaming, push notification configuration, and injected push delivery are proven locally and over loopback/local handler paths only; public readiness is reported locally, but no public hosting, production key distribution, public push webhook delivery, or external conformance proof is complete.",
