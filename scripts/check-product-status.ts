...
function productionBlockers(): readonly ProductEvidenceCheck[] {
  return [
    ...
    },
    {
      ...
      message: "A2A discovery is proven locally and over loopback only; no public hosting, production key distribution, or external conformance proof is recorded.",
      next: "Add a dedicated A2A public hosting/conformance slice before claiming live A2A interoperability.",
    },
    {
