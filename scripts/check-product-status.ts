...
function productionBlockers(): readonly ProductEvidenceCheck[] {
  return [
    ...
    },
    {
      ...
      message: "A2A discovery is proven locally and over loopback only; public readiness is now reported locally, but no public hosting, production key distribution, streaming/push support, or external conformance proof is complete.",
