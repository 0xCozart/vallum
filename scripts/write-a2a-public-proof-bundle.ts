...
const DEFAULT_OUT_FILE = "tmp/vallum/a2a-public-proof-bundle.json";
const DEFAULT_PLAN_OUT_FILE = "tmp/vallum/a2a-public-proof-plan.json";
const DEFAULT_READINESS_OUT_FILE = "tmp/vallum/a2a-public-readiness.json";
const DEFAULT_DISCOVERY_TEMPLATE_OUT_FILE = "tmp/vallum/a2a-public-discovery-report-template.json";
const DEFAULT_PUSH_TEMPLATE_OUT_FILE = "tmp/vallum/a2a-public-push-delivery-report-template.json";
const DEFAULT_CONFORMANCE_TEMPLATE_OUT_FILE = "tmp/vallum/a2a-external-conformance-report-template.json";
...
export async function writeA2APublicProofBundle(
  ...
  const bundle: A2APublicProofBundle = {
    schemaVersion: 1,
    kind: "vallum.a2a-public-proof-bundle",
...
function buildSteps(input: {
  ...
  return [
    ...
    },
    {
      ...
      command: "npm run smoke:a2a-public-discovery -- --report tmp/vallum/a2a-public-discovery-report.json",
