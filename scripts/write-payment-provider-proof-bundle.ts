...
const DEFAULT_OUT_FILE = "tmp/vallum/payment-provider-proof-bundle.json";
const DEFAULT_PLAN_OUT_FILE = "tmp/vallum/payment-provider-proof-plan.json";
const DEFAULT_READINESS_OUT_FILE = "tmp/vallum/payment-provider-readiness.json";
const DEFAULT_TEMPLATE_OUT_FILE = "tmp/vallum/payment-provider-live-report-template.json";
...
export async function writePaymentProviderProofBundle(
  ...
  const bundle: PaymentProviderProofBundle = {
    schemaVersion: 1,
    kind: "vallum.payment-provider-proof-bundle",
