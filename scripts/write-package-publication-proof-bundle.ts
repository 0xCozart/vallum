...
export interface PackagePublicationProofBundle {
  ...
  readonly kind: "agentic-gaskit.package-publication-proof-bundle";
...
const DEFAULT_OUT_FILE = "tmp/gaskit/package-publication-proof-bundle.json";
const DEFAULT_PLAN_OUT_FILE = "tmp/gaskit/package-publication-proof-plan.json";
const DEFAULT_READINESS_OUT_FILE = "tmp/gaskit/package-publication-readiness.json";
const DEFAULT_TEMPLATE_OUT_FILE = "tmp/gaskit/package-publication-report-template.json";
...
export async function writePackagePublicationProofBundle(
  ...
  const bundle: PackagePublicationProofBundle = {
    schemaVersion: 1,
    kind: "agentic-gaskit.package-publication-proof-bundle",
