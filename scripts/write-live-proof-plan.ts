...
export interface LiveProofPlan {
  ...
  readonly kind: "vallum.live-proof-plan";
...
const REQUIRED_OPERATOR_INPUTS = [
  ...
  "VALLUM_TESTNET_UPSTREAM_REPORT",
  "VALLUM_TESTNET_DIGEST_REPORT",
...
const PLAN_COMMANDS: readonly LiveProofPlanCommand[] = [
  ...
  },
  {
    ...
    command: "npm run operator:write-report-template -- --kind testnet-upstream --out tmp/vallum/testnet-upstream-report-template.json",
    contactsLiveService: false,
    requiresOperatorApproval: false,
  },
  {
  ...
  },
  {
    ...
    command: "npm run operator:write-report-template -- --kind testnet-digest --out tmp/vallum/testnet-digest-report-template.json",
    contactsLiveService: false,
    requiresOperatorApproval: false,
  },
  {
  ...
  },
  {
    ...
    command: "npm run operator:write-report-template -- --kind iota-names-live --out tmp/vallum/iota-names-live-report-template.json",
    contactsLiveService: false,
    requiresOperatorApproval: false,
  },
  {
  ...
  },
  {
    ...
    command: "npm run operator:write-report-template -- --kind iota-identity-live --out tmp/vallum/iota-identity-live-report-template.json",
    contactsLiveService: false,
    requiresOperatorApproval: false,
  },
  {
  ...
  },
  {
    ...
    command: "npm run operator:write-report-template -- --kind vc-validation-live --out tmp/vallum/vc-validation-live-report-template.json",
    contactsLiveService: false,
    requiresOperatorApproval: false,
  },
  {
