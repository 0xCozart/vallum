...
export interface CustodyProductionProofBundle {
  ...
  readonly kind: "agentic-gaskit.custody-production-proof-bundle";
...
const DEFAULT_OUT_FILE = "tmp/gaskit/custody-production-proof-bundle.json";
const DEFAULT_PLAN_OUT_FILE = "tmp/gaskit/custody-production-proof-plan.json";
const DEFAULT_READINESS_OUT_FILE = "tmp/gaskit/custody-readiness.json";
const DEFAULT_TEMPLATE_OUT_FILE = "tmp/gaskit/custody-production-report-template.json";
...
export async function writeCustodyProductionProofBundle(
  ...
  const bundle: CustodyProductionProofBundle = {
    schemaVersion: 1,
    kind: "agentic-gaskit.custody-production-proof-bundle",
