...
export interface MarketplaceProductionProofBundle {
  ...
  readonly kind: "vallum.marketplace-production-proof-bundle";
...
const DEFAULT_OUT_FILE = "tmp/vallum/marketplace-production-proof-bundle.json";
const DEFAULT_PLAN_OUT_FILE = "tmp/vallum/marketplace-production-proof-plan.json";
const DEFAULT_READINESS_OUT_FILE = "tmp/vallum/marketplace-readiness.json";
const DEFAULT_TEMPLATE_OUT_FILE = "tmp/vallum/marketplace-production-report-template.json";
...
export async function writeMarketplaceProductionProofBundle(
  ...
  const bundle: MarketplaceProductionProofBundle = {
    schemaVersion: 1,
    kind: "vallum.marketplace-production-proof-bundle",
